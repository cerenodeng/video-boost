export function VideoIcon() {
  return (
    <svg className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 14">
...
export function AddIcon() {
  return (
    <svg className="w-8 h-8 text-neutral-500 hover:text-neutral-700" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
